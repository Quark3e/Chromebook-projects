...
def detectAndDisplay(frame):
    ...
    faces = face_cascade.detectMultiScale(frame_gray, 1.04, 1, 0, [120, 120], [200, 200])
...
parser.add_argument('--face_cascade', help='Path to face cascade.', default= haarCascadePath + 'Hand.Cascade.1.xml')

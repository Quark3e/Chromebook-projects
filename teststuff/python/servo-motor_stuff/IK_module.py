...
def q_corrections(q):
    ...
    q[1] = 1.751*pow(10, -9)*pow(q[1], 5)-7.693*pow(10, -7)*pow(q[1], 4)+0.000117*pow(q[1], 3)-0.006447*pow(q[1], 2)+0.71*q[1]+25.66-10
    q[2] = 4.605*pow(10, -9)*pow(q[2], 5)-2.178*pow(10, -6)*pow(q[2], 4)+0.0003815*pow(q[2],3)- 0.02938*pow(q[2],2)+1.776*q[2]+4.114
